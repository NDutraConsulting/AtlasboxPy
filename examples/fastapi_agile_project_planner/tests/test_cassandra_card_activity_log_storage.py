...
from examples.fastapi_agile_project_planner.app.backend.infrastructure.database.db_connections.card_activity_log_quantum import (
    CassandraQuantum,
)
from examples.fastapi_agile_project_planner.app.backend.infrastructure.database.orm_models.card_activity_log_orm_model import (
